...
import { journeyData, personalPhotos } from "./journeyData";
...
export default function Journey() {
  ...
  const sectionSize = 1 / journeyData.length;
    ...
    <section className="bg-[#FFF8E7]">
      ...
      <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-8 text-center">
        ...
        >
          ...
          <h2 className="mb-6 text-6xl font-bold tracking-tight text-gray-900 md:text-8xl">
            My Journey
          </h2>
      ...
      {/* Horizontal Scroll Cinema Section */}
                ...
                <div className="relative z-10 mx-auto flex h-full max-w-7xl items-center px-8 md:px-16">
                  <div className="grid w-full grid-cols-1 items-center gap-12 md:grid-cols-2 lg:gap-20">
                    ...
                    <div className="flex flex-col justify-center overflow-hidden">
                      ...
                      {/* Title */}
                      <h3 className="mb-4 text-3xl font-bold leading-tight text-gray-900 md:text-4xl lg:text-5xl">
                        {item.title}
                      </h3>
